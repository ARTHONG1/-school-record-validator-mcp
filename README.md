...
2026학년도 **초등학교 학교생활기록부 문안**을 교사가 직접 올리면 통과·수정 권장·기재 불가로 판단해 주는 교육·실습용 MCP 서버입니다. AI는 기본 teacher 모드의 `check_school_record` 도구를 호출하고, 문제가 있을 때 공식 근거와 개선 방향을 설명합니다.
